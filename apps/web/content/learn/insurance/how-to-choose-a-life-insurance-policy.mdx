...
howto:
  ...
  steps:
    ...
    - name: "Step 5: Get quotes from at least three carriers and a broker"
      text: "Request comparable quotes from licensed insurers or a broker. Compare the same coverage amount, term, riders and underwriting assumptions. Haven Life is no longer included as a new application option."
...
- Existing Haven policyholders: [status and account help](/insurance/life/haven-life)
...
No-exam eligibility and decision time depend on the specific product and applicant. Ask whether additional medical evidence may be required; an initial quote is not an approval. See the [life insurance hub](/insurance/life) for comparison questions.
