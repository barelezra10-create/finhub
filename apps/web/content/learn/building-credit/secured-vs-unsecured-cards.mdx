...
**No annual fee.** There are solid secured cards with no annual fee. Annual fees on secured cards eat into the deposit you're already setting aside. The [Discover it Secured](/credit-cards/discover-it-secured) charges no annual fee and earns cash back on purchases.
...
- The [Discover it Secured](/credit-cards/discover-it-secured) is a common recommendation because it has no annual fee, earns cash back, and has a clear graduation track
...
- Use the [card recommendation tool at /calculators/which-card](/calculators/which-card) to see what you'd likely qualify for before applying
