...
const states: State[] = [
  { name: "Alabama", slug: "alabama", avgApr: 6.70, region: "South" },
  { name: "Alaska", slug: "alaska", avgApr: 6.82, region: "West" },
  { name: "Arizona", slug: "arizona", avgApr: 6.66, region: "West" },
  { name: "Arkansas", slug: "arkansas", avgApr: 6.72, region: "South" },
  { name: "California", slug: "california", avgApr: 6.57, region: "West" },
  { name: "Colorado", slug: "colorado", avgApr: 6.60, region: "West" },
  { name: "Connecticut", slug: "connecticut", avgApr: 6.64, region: "Northeast" },
  { name: "Delaware", slug: "delaware", avgApr: 6.68, region: "South" },
  { name: "Florida", slug: "florida", avgApr: 6.62, region: "South" },
  { name: "Georgia", slug: "georgia", avgApr: 6.65, region: "South" },
  { name: "Hawaii", slug: "hawaii", avgApr: 6.75, region: "West" },
  { name: "Idaho", slug: "idaho", avgApr: 6.69, region: "West" },
  { name: "Illinois", slug: "illinois", avgApr: 6.63, region: "Midwest" },
  { name: "Indiana", slug: "indiana", avgApr: 6.67, region: "Midwest" },
  { name: "Iowa", slug: "iowa", avgApr: 6.61, region: "Midwest" },
  { name: "Kansas", slug: "kansas", avgApr: 6.66, region: "Midwest" },
  { name: "Kentucky", slug: "kentucky", avgApr: 6.71, region: "South" },
  { name: "Louisiana", slug: "louisiana", avgApr: 6.79, region: "South" },
  { name: "Maine", slug: "maine", avgApr: 6.68, region: "Northeast" },
  { name: "Maryland", slug: "maryland", avgApr: 6.61, region: "South" },
  { name: "Massachusetts", slug: "massachusetts", avgApr: 6.59, region: "Northeast" },
  { name: "Michigan", slug: "michigan", avgApr: 6.66, region: "Midwest" },
  { name: "Minnesota", slug: "minnesota", avgApr: 6.62, region: "Midwest" },
  { name: "Mississippi", slug: "mississippi", avgApr: 6.80, region: "South" },
  { name: "Missouri", slug: "missouri", avgApr: 6.67, region: "Midwest" },
  { name: "Montana", slug: "montana", avgApr: 6.74, region: "West" },
  { name: "Nebraska", slug: "nebraska", avgApr: 6.64, region: "Midwest" },
  { name: "Nevada", slug: "nevada", avgApr: 6.71, region: "West" },
  { name: "New Hampshire", slug: "new-hampshire", avgApr: 6.63, region: "Northeast" },
  { name: "New Jersey", slug: "new-jersey", avgApr: 6.66, region: "Northeast" },
  { name: "New Mexico", slug: "new-mexico", avgApr: 6.75, region: "West" },
  { name: "New York", slug: "new-york", avgApr: 6.70, region: "Northeast" },
  { name: "North Carolina", slug: "north-carolina", avgApr: 6.62, region: "South" },
  { name: "North Dakota", slug: "north-dakota", avgApr: 6.73, region: "Midwest" },
  { name: "Ohio", slug: "ohio", avgApr: 6.65, region: "Midwest" },
  { name: "Oklahoma", slug: "oklahoma", avgApr: 6.77, region: "South" },
  { name: "Oregon", slug: "oregon", avgApr: 6.64, region: "West" },
  { name: "Pennsylvania", slug: "pennsylvania", avgApr: 6.67, region: "Northeast" },
  { name: "Rhode Island", slug: "rhode-island", avgApr: 6.69, region: "Northeast" },
  { name: "South Carolina", slug: "south-carolina", avgApr: 6.66, region: "South" },
  { name: "South Dakota", slug: "south-dakota", avgApr: 6.72, region: "Midwest" },
  { name: "Tennessee", slug: "tennessee", avgApr: 6.64, region: "South" },
  { name: "Texas", slug: "texas", avgApr: 6.68, region: "South" },
  { name: "Utah", slug: "utah", avgApr: 6.63, region: "West" },
  { name: "Vermont", slug: "vermont", avgApr: 6.71, region: "Northeast" },
  { name: "Virginia", slug: "virginia", avgApr: 6.61, region: "South" },
  { name: "Washington", slug: "washington", avgApr: 6.59, region: "West" },
  { name: "West Virginia", slug: "west-virginia", avgApr: 6.78, region: "South" },
  { name: "Wisconsin", slug: "wisconsin", avgApr: 6.65, region: "Midwest" },
  { name: "Wyoming", slug: "wyoming", avgApr: 6.76, region: "West" },
  { name: "District of Columbia", slug: "district-of-columbia", avgApr: 6.62, region: "South" },
];
      ...
      <section className="border-y border-line bg-bg-soft/60">
        <div className="max-w-(--max-w-page) mx-auto px-6 py-10">
          <div className="flex items-center justify-between mb-6">
            ...
            <span className="text-xs font-mono text-mute">Source: Freddie Mac PMMS, August 2026</span>
          </div>
