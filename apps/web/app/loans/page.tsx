...
const loanLenders: LoanLender[] = [
  ...
  },
  {
    ...
    startingApr: 6.99,
    tagline: "Loan amounts up to $40K; no origination or prepayment fees advertised. Selected terms checked September 14, 2026.",
    creditTier: "Good",
    loanRange: "$2.5K to $40K",
    termMonths: "36 to 84",
    fundingTime: "As soon as next business day; conditions apply",
    bestFor: "Returning Discover customers who value U.S. support",
    perks: [
      "No origination, late, or prepayment fees",
      "36 to 84 month repayment terms",
      "Direct creditor-pay restrictions apply",
    ],
    trend: "flat",
  },
  {
