...
export default function Page() {
  return (
    <article className="bg-bg">
      ...
      <section className="max-w-(--max-w-page) mx-auto px-6 pb-12">
        <VisitBrandCard brand={brand} tagline="2% unlimited cash back · 0% intro APR 12 months · No fee" />
      </section>
      ...
      <section className="max-w-(--max-w-page) mx-auto px-6 pb-20">
        <VisitBrandCard
          ...
          tagline="2% unlimited cash back · 0% intro APR 12 months · No fee"
          ctaLabel="Open account"
        />
        <div className="mt-6 flex flex-wrap gap-3">
          <Link href="/credit-cards/cash-back" className="pill pill-ghost">
            Best cash back cards <span aria-hidden>→</span>
          </Link>
        </div>
      </section>
    </article>
