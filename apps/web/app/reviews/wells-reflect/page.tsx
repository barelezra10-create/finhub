...
export default function Page() {
  return (
    <article className="bg-bg">
      ...
      <section className="max-w-(--max-w-page) mx-auto px-6 pb-12">
        <VisitBrandCard brand={brand} tagline="21 months 0% intro APR on purchases and balance transfers" />
      </section>
      ...
      <section className="max-w-(--max-w-page) mx-auto px-6 pb-20">
        <VisitBrandCard
          ...
          tagline="21 months 0% intro APR on purchases and balance transfers"
          ctaLabel="Open account"
        />
        <div className="mt-6 flex flex-wrap gap-3">
          <Link href="/credit-cards/zero-apr" className="pill pill-ghost">
            Best 0% APR cards <span aria-hidden>→</span>
          </Link>
        </div>
      </section>
    </article>
