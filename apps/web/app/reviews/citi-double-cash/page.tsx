...
export default function Page() {
  return (
    <article className="bg-bg">
      ...
      <section className="max-w-(--max-w-page) mx-auto px-6 pb-12">
        <VisitBrandCard brand={brand} tagline="2% cash back on everything · No annual fee" />
      </section>
      ...
      <section className="max-w-(--max-w-page) mx-auto px-6 pb-20">
        <VisitBrandCard
          ...
          tagline="2% cash back on everything · No annual fee"
          ctaLabel="Open account"
        />
        <div className="mt-6 flex flex-wrap gap-3">
          <Link href="/credit-cards/no-fee" className="pill pill-ghost">
            Best no-annual-fee cards <span aria-hidden>→</span>
          </Link>
        </div>
      </section>
    </article>
