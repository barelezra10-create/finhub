...
export async function GET(request:NextRequest) {
  ...
  const fields=['created_at','kind','path','source','channel','search_engine','referrer','medium','campaign','country','region','city','device','browser','os','language','keyword','keyword_type','target','offer','placement'];
