const tickerItems: Array<{ label: string; value: string; delta: number }> = [
  { label: "30Y FIXED", value: "6.67%", delta: -0.02 },
  { label: "15Y FIXED", value: "5.96%", delta: -0.05 },
  { label: "REFI 30Y", value: "6.82%", delta: -0.01 },
  { label: "HELOC", value: "7.30%", delta: 0.0 },
  { label: "JUMBO 30Y", value: "6.88%", delta: -0.02 },
  { label: "HYSA TOP", value: "3.95%", delta: -0.05 },
  { label: "12M CD", value: "4.30%", delta: 0.0 },
  { label: "24M CD", value: "4.05%", delta: -0.02 },
  { label: "5Y CD", value: "4.00%", delta: 0.01 },
  { label: "MMA TOP", value: "3.85%", delta: 0.0 },
  { label: "AUTO 60M NEW", value: "7.10%", delta: -0.02 },
  { label: "AUTO 60M USED", value: "8.45%", delta: 0.04 },
  { label: "PERSONAL EXC.", value: "7.49%", delta: 0.0 },
  { label: "10Y TREASURY", value: "4.30%", delta: 0.01 },
];
